...
var now = new Date();
var LineLogComponent = /** @class */ (function () {
    function LineLogComponent(deviceHistoryService) {
    ...
    LineLogComponent.prototype.ngOnInit = function () {
        this.getlogs();
    };
    LineLogComponent.prototype.getlogs = function () {
        var that = this;
    ...
    // 返回
    LineLogComponent.prototype.goback = function () {
        window.history.back();
    };
    // 分页获取数据
    LineLogComponent.prototype.pageChange = function () {
        this.getlogs();
    };
    // 搜索
    LineLogComponent.prototype.dataSearch = function () {
        this.page = 1;
        this.getlogs();
    };
    LineLogComponent = __decorate([
        core_1.Component({
    ...
    return LineLogComponent;
}());
exports.LineLogComponent = LineLogComponent;
//# sourceMappingURL=line-log.component.js.map